...
public class AddNhaCungCap extends javax.swing.JDialog {
    ...
    public AddNhaCungCap(Frame jf, boolean modal) {
        super(jf, modal);
        initComponents();
        setLocationRelativeTo(null);
    }
    
    public AddNhaCungCap(Frame jf, boolean modal, AdminController ad) {
        super(jf, modal);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 160, 24));

        txtTenNhaCungCap.setFont(new java.awt.Font("SF Pro Display", 0, 16)); // NOI18N
        txtTenNhaCungCap.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 210, -1));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 130, -1));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            if (txtMaNhaCungCap.getText().isBlank()
                    || txtTenNhaCungCap.getText().isBlank() 
            ...
            adminController.sendMessage("addSupplier;" + txtMaNhaCungCap.getText() + ","
